...
from equipment_isolation.domain.isolation_actions import is_field_confirmed_positive_candidate, is_installed_positive_isolation
from equipment_isolation.domain.topology import PROCESS_LINE_CLASSES
