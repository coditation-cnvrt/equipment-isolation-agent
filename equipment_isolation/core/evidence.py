...
from equipment_isolation.domain.enums import IsolationDecision, ObligationStatus, SourceType
from equipment_isolation.domain.isolation_actions import is_installed_positive_isolation, is_operable_barrier
from equipment_isolation.domain.keywords import VERIFICATION_ENTITY_KEYWORDS, VERIFY_TAG_PREFIXES
...
def _classification_from_payload(payload):
    from equipment_isolation.domain.models import CandidateClassification
