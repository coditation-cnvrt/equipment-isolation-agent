...
from equipment_isolation.domain.hilt_geometry import valid_bbox as _valid_bbox
from equipment_isolation.domain.topology import PROCESS_LINE_CLASSES, normalize_tag


CATALOG_RESOURCE = files("equipment_isolation.domain").joinpath(
