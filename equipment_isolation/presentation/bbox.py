...
from equipment_isolation.presentation.bbox_util import (
    _dedupe_source_candidates,
    _selectable_candidate_pool,
    _source_key,
)
from equipment_isolation.integrations.hilt_merge import _hilt_source_entries, _merge_hilt_source_branches, _merge_hilt_topology
from equipment_isolation.domain.enums import FlowRole
from equipment_isolation.core.flow import classify_nozzle_flow, role_for_source
from equipment_isolation.integrations.hilt_topology import resolve_nozzle_isolation, resolve_source_branch_isolation
from equipment_isolation.domain.hilt_geometry import calibrate_yflip as _calibrate_hilt_yflip
from equipment_isolation.integrations.hilt_index import (
    _dedupe_hilt_lines,
...
from equipment_isolation.presentation.bbox_geometry import (
    _bbox_distance,
    _bbox_near,
    _looks_like_nozzle_label,
)
from equipment_isolation.integrations.stlm_payload import (
    _extract_text_items,
    _fallback_hilt_yflip,
)
from equipment_isolation.domain.hilt_geometry import extract_symbols as _extract_symbols
from equipment_isolation.domain.hilt_geometry import symbol_attr as _symbol_attr
from equipment_isolation.domain.hilt_geometry import symbol_bbox as _symbol_bbox
from equipment_isolation.domain.topology import CONTEXT_LINE_CLASSES, PROCESS_LINE_CLASSES, SIGNAL_LINE_CLASSES, normalize_tag
from equipment_isolation.domain.topology import tag_prefix as _tag_prefix
