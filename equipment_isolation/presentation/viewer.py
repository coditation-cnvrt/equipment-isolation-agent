...
from equipment_isolation.domain.enums import ImpactSeverity, ObligationStatus, OverlayKind, SourceType
from equipment_isolation.core.secondary_context import build_secondary_energy_context, context_source_label
from equipment_isolation.presentation.viewer_overlays import (
    _collect_overlays,
...
# exact strings validator.validate() emits (see equipment_isolation.domain.enums.AssuranceStatus).
