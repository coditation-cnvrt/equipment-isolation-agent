...
unlike the shared equipment_isolation.domain.hilt_geometry.valid_bbox. Tightening it would silently
drop zero-area overlays from rendered output. tests/test_geometry_helpers.py pins
the difference.
"""
from __future__ import annotations

from equipment_isolation.domain.display import device_display_label
from equipment_isolation.domain.isolation_actions import manual_candidate_label
from equipment_isolation.domain.enums import ImpactSeverity, OverlayKind
from equipment_isolation.domain.models import BBox, Overlay
from equipment_isolation.core.secondary_context import context_display_label, context_source_label
